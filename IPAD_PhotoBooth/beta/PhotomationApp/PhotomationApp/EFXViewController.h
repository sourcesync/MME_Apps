...
@property (nonatomic, retain) IBOutlet UIImageView *img_one;
@property (nonatomic, retain) IBOutlet UIImageView *img_two;
@property (nonatomic, retain) IBOutlet UIImageView *img_three;
@property (nonatomic, retain) IBOutlet UIImageView *img_four;
@property (nonatomic, retain) IBOutlet UIImageView *img_five;
