...
if ((file_exists("event/$skin/web2.html"))) {

	$filename = "event/$skin/web2.html";
	...
	$tinyurl = getTinyUrl("http://" . $server . "/favoritephoto.php?viewing=" . $skin . "_" . $id);
        
        if ($tinyurl == "")
            $tinyurl = "http://" . $server . "/favoritephoto.php?viewing=" . $skin . "_" . $id;
