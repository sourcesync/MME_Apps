...
- (void) viewWillAppear:(BOOL)animated
{
    ...
    if (!self.rescan)
    {
        self.baseImage.image = [ UIImage imageNamed:@"iphone-splashscreen-scanbox-hole.png" ];
        self.vImage.frame = CGRectMake(12, 125, 140, 210);
        self.vImagePreview.frame = CGRectMake(12, 125, 140, 210);
    }
    else 
    {
